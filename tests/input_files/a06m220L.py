...
prior = gv.BufferDict()
prior = {
    'sigma_E': np.array(['0.53(22)', '0.8(3.2)', '1.0(3.2)', '1.1(3.2)'], dtype=object),
    'sigma_st_E': np.array(['0.5(22)', '0.6(3.2)', '1.0(3.2)', '1.1(3.2)'], dtype=object),
    ...
    'proton_E': np.array(['0.41(22)', '0.6(2.2)', '0.75(2.2)', '1.1(2.2)'], dtype=object),
